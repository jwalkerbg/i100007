...
#define __pyx_kp_u_Hello_to_Python_world_from_Cytho __pyx_string_tab[1]
#define __pyx_kp_u_src_pymodule_extensions_hello_wo __pyx_string_tab[2]
...
#define __pyx_n_u_hello __pyx_string_tab[7]
#define __pyx_n_u_hello_world __pyx_string_tab[8]
...
#define __pyx_n_u_values __pyx_string_tab[18]
#define __pyx_kp_b_iso88591_1 __pyx_string_tab[19]
...
*/
  ...
  __Pyx_INCREF(__pyx_mstate_global->__pyx_kp_u_Hello_to_Python_world_from_Cytho);
  __pyx_r = __pyx_mstate_global->__pyx_kp_u_Hello_to_Python_world_from_Cytho;
  goto __pyx_L0;
...
static int __pyx_pymod_exec_hello_world(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_hello_world},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_hello_world(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_hello_world(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'hello_world' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "hello_world" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_hello_world", 0);
  ...
  }
  {
    ...
    if (!PyDict_GetItemString(modules, "hello_world")) {
      if (unlikely((PyDict_SetItemString(modules, "hello_world", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *     return "Hello to Python world from Cython world!"
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_11hello_world_1hello, 0, __pyx_mstate_global->__pyx_n_u_hello, NULL, __pyx_mstate_global->__pyx_n_u_hello_world, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_hello, __pyx_t_2) < (0)) __PYX_ERR(0, 3, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{40},{51},{20},{18},{18},{8},{5},{11},{13},{5},{8},{10},{8},{12},{12},{10},{8},{6},{7}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (236 bytes) */
const char* const cstring = "BZh91AY&SY\030\241\022|\000\000\n\337\302d\010`\001\240\000\214AP\000\277o\377\340@@\000@0\000\270\330j\232b\0324\r4\003@\000\365\006\2422zCF\232\r\000\000\000h%\036\206\232\032&\200\311\241\265=\023\324\270\r\347\303=:\236\201\020\373\236\276'\205\323\306\320\247#\000\346\204\014\300}e\253\253V\204\342\025\350\303\r;\013op\337\363J!\315X\231\275\331\313b\026\332\020XT\302W\254v\002\220\247\205\202Q\300v\275E\311@\227%\275\202\016eK\211\007\204R\024PA\211SP\260\330\222\034\037Q(\222h\td\203\231\300\353\240#\343\tB\003ldM\220\302\323\207J\266D\304\366\206\233:*\225\0024\251\242\261i\311X\205\261\202\010A\236PX\370\247|\214s\221~.\344\212p\241 1B$\370";
    PyObject *data = __Pyx_DecompressString(cstring, 236, 2);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (185 bytes) */
const char* const cstring = "x\332M\216=\016\3020\014\205\205\304\306%\302\005Zq\002\006\030\230P\305\005\254\220\272\"\"\211!v\240\331\0309\"\307!-?\252\207\347\247'\177\326[\357\3209RB\252\311r\242\240\356\024]\253\272H^m&\311\222\243\251/\331S\233\034\326\330\013\006\266\024\270>\r<\2147S_]r\017\320\024i\362\326\032\201}a\016\330i\316\301X\252\014EJb\003\262qE\301\006\220\250\r\036\2659\003t)\030\200\361\335\344'X\206?g\005=\003x]\3102\237b\203\013\332\217\373\232\264\373yF\371\346\305\265\245Er\002 \310Eo\332%\344\307\3545_<Wo}\222kQ";
    PyObject *data = __Pyx_DecompressString(cstring, 185, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (271 bytes) */
const char* const bytes = "?Hello to Python world from Cython world!src/pymodule/extensions/hello_world/hello_world.pyx__Pyx_PyDict_NextRefasyncio.coroutinescline_in_traceback__func__hellohello_world_is_coroutineitems__main____module____name____qualname____set_name__setdefault__test__values\200\001\330\004\013\2101";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {0, 0, 0, 0, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 3};
    PyObject* const varnames[] = {0};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_src_pymodule_extensions_hello_wo, __pyx_mstate->__pyx_n_u_hello, __pyx_mstate->__pyx_kp_b_iso88591_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
